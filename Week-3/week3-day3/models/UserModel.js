// user model helps us to how the data of user is stored in a database
 import { Schema, model,Types } from "mongoose" // schema --> stru of data 
...
const cartSchema =new Schema(
    {
      product:{
        type:Types.ObjectId,
        ref:"product"   // name of the product model not collection not products
      },
      count:{
        type:Number,
        default:1
...
const userSchema = new Schema(
{
    ...
    cart:[cartSchema]  // it can accept only product and count
},
{
...
export const UserModel = model("user", userSchema) 
 // take two ars nameofthemodel and userschema
 // nameofthemodel it represent the collection